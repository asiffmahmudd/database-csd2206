...
ALTER TABLE PRODUCTS
  ...
  CHECK ( warranty BETWEEN 10 AND 99 );
...
(DEFAULT, 'SL39', '43.4 x 33 x 7.5 cm', NULL),
(DEFAULT, 'XP53', '39.7 x 29 x 7.6 cm', 3),
(DEFAULT, 'HZ12', '42.3 x 35 x 9.1 cm', NULL);
...
(DEFAULT, 'John Sanders', '10-11-2021', 'johnsanders@gmail.com', '4373232123', '43 Eglington, M1L4V5, ON'),
(DEFAULT, 'Bruce Wayne', '15-08-2021', 'brucewayne@gmail.com', '4374563435', '72 Birchmount, M3T8R7, BC'),
(DEFAULT, 'Clark Kent', '17-02-2021', 'clarkkent@gmail.com', '4378696745', '125 Silvio, K1J7F9, PI'),
(DEFAULT, 'Tony Stark', '23-04-2021', 'tonystark@gmail.com', '4375674563', '64 Patterson, M1H2I8, IL'),
(DEFAULT, 'Roger Ends', '09-10-2021', 'rogerends@gmail.com', '4374563244', '89 Thyras, L1L9U8, ON');
...
INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '23-05-2021', 127.98, 600, 503);
INSERT INTO PRODUCT_ORDER VALUES
(12, PREVIOUS VALUE FOR order_id_seq, 35.98, 1),
(13, PREVIOUS VALUE FOR order_id_seq, 37.99, 2);

INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '19-06-2021', 248.99, 601, 500);
INSERT INTO PRODUCT_ORDER VALUES
(17, PREVIOUS VALUE FOR order_id_seq, 81.99, 1),
(14, PREVIOUS VALUE FOR order_id_seq, 73.99, 2);


INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '26-06-2021', 159.98, 600, 501);
INSERT INTO PRODUCT_ORDER VALUES
(10, PREVIOUS VALUE FOR order_id_seq, 67.99, 1),
(11, PREVIOUS VALUE FOR order_id_seq, 58.99, 1);

INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '30-06-2021', 177.98, 602, 503);
INSERT INTO PRODUCT_ORDER VALUES
...
INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '23-07-2021', 178.25, 601, 502);
INSERT INTO PRODUCT_ORDER VALUES
(14, PREVIOUS VALUE FOR order_id_seq, 43.99, 2),
(13, PREVIOUS VALUE FOR order_id_seq, 37.99, 1);

INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '29-07-2021', 203.95, 600, 504);
INSERT INTO PRODUCT_ORDER VALUES
(11, PREVIOUS VALUE FOR order_id_seq, 58.99, 1),
(10, PREVIOUS VALUE FOR order_id_seq, 67.99, 2);

INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '11-08-2021', 305.93, 600, 502);
INSERT INTO PRODUCT_ORDER VALUES
...
INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '19-08-2021', 149.99, 602, 501);
INSERT INTO PRODUCT_ORDER VALUES
(13, PREVIOUS VALUE FOR order_id_seq, 37.99, 2),
(12, PREVIOUS VALUE FOR order_id_seq, 35.98, 2);

INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '04-09-2021', 137.93, 602, 504);
INSERT INTO PRODUCT_ORDER VALUES
(10, PREVIOUS VALUE FOR order_id_seq, 67.99, 1),
(11, PREVIOUS VALUE FOR order_id_seq, 58.99, 1);

INSERT INTO ORDERS VALUES (NEXT VALUE FOR order_id_seq, '13-10-2021', 219.75, 601, 500);
INSERT INTO PRODUCT_ORDER VALUES
